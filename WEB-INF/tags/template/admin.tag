    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q1</span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-users"></i> <span>Q7/span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q2</span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q3</span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q4</span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q5</span>
                        </a>
                    </li>
                    <li class="">
                    <a href="">
                        <i class="fa fa-try"></i> <span>Q6</span>
                        </a>
                    </li>
                </ul>
            </section>
