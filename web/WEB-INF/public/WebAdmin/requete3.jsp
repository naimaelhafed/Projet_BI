    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Le rendement de chaque Client par années  :
                </h3>
                <form method="POST" action="" class="row">
                    <c:forEach var="item" items="${year}">
                        <button type="submit" class="btn  btn-primary" value="${item.get(0)}" name="annee"><span>${item.get(0)}</span></button>
                            </c:forEach>
        ...
        <script>
            ...
            <c:forEach var="liste"  items="${requestScope['list']}" >
